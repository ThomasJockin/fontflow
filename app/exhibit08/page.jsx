...
const check = userAnswer === "human";
    ...
    if (choice === actualAnswer) {
        return <div><label className="exhibitanswer">Correct. This is <strong>{actualAnswer} made by Thomas Jockin</strong>.</label></div>;
    }

    return <div><label className="exhibitanswer">Nope. This is <strong>{actualAnswer} made by Thomas Jockin</strong>. </label></div>;
}
  return (
